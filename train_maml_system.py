...
## python train_maml_system.py --name_of_args_json_file experiment_config/my_experiment/MAML_Curriculum.json --gpu_to_use 0
## python train_maml_system.py --name_of_args_json_file experiment_config/my_experiment/alfa+maml.json --gpu_to_use 0
