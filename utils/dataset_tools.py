...
def maybe_unzip_dataset(args):
    ...
    for dataset_idx, dataset_path in enumerate(dataset_paths):
        ...
        if not os.path.exists(dataset_path):
            ...
            zip_directory = "{}.tar.bz2".format(os.path.join(DATASET_DIR, datasets[dataset_idx]))
            ...
            unzip_file(
                filepath_pack=os.path.join(DATASET_DIR, "{}.tar.bz2".format(datasets[dataset_idx])),
                filepath_to_store=DATASET_DIR)
