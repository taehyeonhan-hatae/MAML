...
class MAMLFewShotClassifier(nn.Module):
            ...
            for num_step in range(num_steps):
                ...
                if use_multi_step_loss_optimization and training_phase and epoch < self.args.multi_step_loss_num_epochs:
                    ...
                    if self.args.arbiter:
                        ...
                        task_rate = self.arbiter(per_step_task)
                        target_loss = task_rate * target_loss

                        comprehensive_losses["task_rate_" + str(num_step)] = task_rate
                        comprehensive_losses["task_rate_target_loss" + str(num_step)] = task_rate * target_loss
    ...
    def net_forward(self, x, y, weights, backup_running_statistics, training, num_step, current_epoch):
        """
        ...
        return loss, original_logits, loss_with_dropout
        # return loss, preds
